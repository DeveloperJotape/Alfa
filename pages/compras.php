                        ...
                        <form action="compras.php?action=add&id=<?php echo $row['id'];?>" method="POST">
                            <div class="card bg-color-2 font-color ml-3 mr-3 mt-3" style="width: 20rem;">
                                <img class="card-img-top" src="../images/<?php echo $row['imagem'];?>"
                                    style="height: 15rem;" alt="<?php echo $row['descricao']?>">
                                <div class="card-body">
                                    ...
                                    <input type="submit" name="add" id="add" value="Adicionar ao carrinho"
                                        style="width: 78%;">
                                </div>
                            </div>
                        </form>
                ...
                <div class="container mt-5 mb-5">
                    ...
                    <div class="card w-100 bg-color-1 mb-3">
                        <div class="card-body row">
                            ...
                            <div class="col font-color-secundary d-flex align-items-start flex-column bd-highlight"
                                style="width:80%;">
                                <h4 class="card-title"><?php echo $row['nome'];?></h4>
                                <h5>Quantidade: <b><?php echo $row['quantidade'];?></b></h5>
                                <h5>Valor: <b><?php echo number_format($row['quantidade']*$row['valor'],2)?></b></h5>
                                <div class="mt-auto bd-highlight">
                                    <a href="compras.php?action=delete&nome=<?php echo $row['nome'];?>"
